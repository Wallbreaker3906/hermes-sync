...
§
常玻(supplierID=131)：常州玻璃钢造船厂有限公司。船舶建造→水上运动休闲→游览船(003)。2SKU：CB2600仿古(排序3500,后6位000004)、CB2800新能源(排序3501,后6位000005)。船舶建造排序最后=2583，新增从3502起。后6位按三级分类编号：游览船(003)最后=000005；无人艇(008)最后=000028(欧卡沧巡000027-28)。
§
